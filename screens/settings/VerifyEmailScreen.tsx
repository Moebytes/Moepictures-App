...
const VerifyEmailScreen: React.FunctionComponent = () => {
    ...
    const verifyEmail = async () => {
        ...
        try {
            await functions.http.post("/api/user/verifyemail", {email, captchaResponse}, session)
            navigation.navigate("Profile", undefined, {pop: true})
            Toast.show({text1: i18n.pages.verifyEmail.submitHeading})
            setError("")
        } catch (err: any) {
        ...
        <View style={{flex: 1, backgroundColor: colors.mainColor}}>
            ...
            <View style={styles.navContainer}>
                ...
                {({pressed}) => (
                    ...
                    <Text style={[styles.navText, pressed && {color: colors.iconColor}]}>{i18n.pages.verifyEmail.title}</Text>
                    </>
                )}
                </PressableHaptic>
            </View>
            <ImageBackground 
                ...
                <CrossLiquidGlassView effect="clear" style={[styles.box]}>
                    ...
                    <View style={styles.row}>
                        <View style={styles.inputWrapper}>
                            ...
                            <TextInput 
                                ...
                                placeholder={i18n.pages.verifyEmail.optionalAddressChange}
                    ...
                    <View style={styles.centerRow}>
                        ...
                        style={styles.wideButton} onPress={verifyEmail}>
                        {({colorAnim}) => {
